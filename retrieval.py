...
class Retriever:
    def __init__(self, data_dir="data"):
        ...
        self.embedder = SentenceTransformer(RERANKER_MODEL_NAME)
    ...
    def hybrid_search(self, query, final_k=10):
        dense = self.dense_search(query, top_k=30)
        bm25 = self.bm25_search(query, top_k=30)
        fused = {}
    ...
    def retrieve(self, query, method="reranker", top_k=5):
        ...
        if method == "reranker":
            return self.rerank_search(query, candidate_k=max(20, top_k), final_k=top_k)
