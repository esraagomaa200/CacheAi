...
### غير متكوميت
- `backend/routers/live.py`: ‏start_of_speech_sensitivity=LOW (هيتكوميت مع حزمة الصوت الجذرية)

### شغال حاليًا
- **الحل الجذري للصوت** (وكيل): WebRTC-loopback AEC + ‏Silero VAD بدل ترقيعات RMS
